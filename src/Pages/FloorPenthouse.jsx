...
import PenthouseMap from "../components/PenthouseMap";
import { useState } from "react";
import Tippy from "@tippyjs/react";
import "tippy.js/dist/tippy.css";

export default function FloorPenthouse() {
  const images = [T1.penthouse];
      ...
      >
        ...
        >
          <div className="bg-[#333333]/90 text-white p-4 rounded-lg w-64">
            {/* Header */}
            <div className="mb-4">
              <h2 className="text-lg font-semibold ml-20 mb-3">
